...
MACRO_CONFIG_INT(ClFullOptions, cl_full_options, 0, 0, 1, CFGFLAG_CLIENT, "Display normal teeworlds options.")
...
MACRO_CONFIG_INT(SvGrenadeSmartRegen, sv_grenade_smart_regen, 1, 0, 1, CFGFLAG_SERVER, "Smart regen (regeneration on kill and rj)")
