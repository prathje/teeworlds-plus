...
MACRO_CONFIG_INT(AccountBatchLogin, account_batch_login, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SERVER, "Login to multiple account servers")
...
MACRO_CONFIG_INT(GfxAsyncRender, gfx_asyncrender, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Do rendering async from the update")
...
MACRO_CONFIG_INT(SvPort, sv_port, 8303, 0, 0, CFGFLAG_SERVER|CFGFLAG_ACCOUNT, "Port to use for the server")
...
MACRO_CONFIG_INT(SvUseAccounts, sv_accounts, 0, 0, 2, CFGFLAG_SERVER, "Enable/disable accounts 2: dont check port")
